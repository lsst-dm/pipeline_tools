...
from lsst.pipeline.tools import add_tasks_to_pipeline
from lsst.pipeline.tools.utils.test_utils import make_test_reference_pipeline
...
class PipelineToolsUtilsTestCase(TestCase):
    ...
    def test_add_tasks_to_pipeline(self):
        ...
        expected_new_subset_labels = set(input_pipeline1.task_labels) | set(
            input_pipeline2.task_labels
        )
